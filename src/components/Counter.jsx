  ...
  return (
    <>
      <div className='d-flex align-items-center justify-content-center w-100 mt-5 flex-column'>
          ...
          <h1 style={{fontSize:'90px',color:'black'}}>{count}</h1>
          <div className='mt-5'>
          ...
          {/* input box */}
          <div>
            <input onChange={(e)=>setRange(e.target.value)} type="text" className='form-control w-100 mt-3 text-center' placeholder='Enter the range' style={{borderColor:'blue'}}/>
          </div>
